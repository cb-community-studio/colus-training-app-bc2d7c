...
const UserdetailsFakerDialogComponent = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .then((data) => {
              setusernameIds(data.data);
            });

    }, [props.show]);

    const onRun = async () => {
        let fakeData = userdetailsFakerFactory(fakerCount,usernameIds);
...
export default connect(null, mapDispatch)(UserdetailsFakerDialogComponent);
